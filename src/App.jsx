  ...
  return (
    <>
        ...
        <div className="contact-details">
          ...
          <div className="contact-form">
            <a href="mailto:edchicort@gmail.com">
              <button className="email-btn">Enviame un correo</button>
            </a>
          </div>
        </div>
        <h3 className="contact-h3">Sígueme en:</h3>
        <div className="social-container">
          {/* GitHub */}
          <div className="tooltip github-tooltip">
            <a
              href="https://github.com/EdgarOrtiz98"
              target="_blank"
              rel="noopener"
            >
          ...
          <div className="tooltip facebook-tooltip">
            <a
              href="https://www.facebook.com/edgar.ortiz.636451/"
              target="_blank"
              rel="noopener"
            >
          ...
          <div className="tooltip instagram-tooltip">
            <a
              href="https://www.instagram.com/e_d_g_a_r_o_r_t_i_z/"
              target="_blank"
              rel="noopener"
            >
          ...
          <div className="tooltip youtube-tooltip">
            <a
              href="https://www.youtube.com/@edgarortizdev"
              target="_blank"
              rel="noopener"
            >
      ...
      <footer className="footer">
        <p>© 2025 Edgar Ortiz Chico. Todos los derechos reservados.</p>
      </footer>
    </>
  );
}
